...
이와 관련된 추측에서 웃긴대학과 마찬가지로 부정클릭으로 계정이 삭제되었다는 글이 블로거들 사이에 올라오고 있는데 팔글에선 계정은 삭제되지 않았음을 비공식적으로 확인했습니다.
...
올블로그의 이번 사건을 팔글에서 확인해 본 결과 아직 계정 삭제가 된 것은 아님을 확인했습니다.
