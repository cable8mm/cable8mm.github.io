...
[제가 만든 AI 기반 GitHub 이슈 생성 CLI 도구인 **`ai-issue`**]({% post 2026-06-14-introduce-ai-issue-to-you %})를 로컬에서 아주 만족스럽게 사용하고 있었습니다. 터미널에서 명령어 하나로 이슈를 발행해 주는 경험이 꽤 마음에 들었습니다.
